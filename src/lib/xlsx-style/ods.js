...
var get_utils = function() {
	...
	if(typeof module !== "undefined" && typeof require !== 'undefined') try {
		return require('./index').utils;
	} catch(e) {
		try { return require('./index').utils; }
		catch(ee) { return require('./index').utils; }
	}
...
if (typeof exports !== 'undefined') {
	if (typeof module !== 'undefined' && module.exports) {
		if(has_buf && typeof jszip === 'undefined') jszip = require('xlsx-style/dist/jszip');
		if(typeof jszip === 'undefined') jszip = require('xlsx-style/dist/jszip').JSZip;
		_fs = require('f'+'s');
	}
}
var attregexg=/\b[\w:-]+=["'][^"]*['"]/g;
